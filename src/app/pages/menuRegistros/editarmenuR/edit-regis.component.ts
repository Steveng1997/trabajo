...
import { EditRegisService } from 'src/app/servicios/editar/edit-regis.service';

@Component({
  selector: 'app-edit-regis',
  templateUrl: '../editarmenuR/edit-regis.component.html',
  styleUrls: ['../editarmenuR/edit-regis.component.css']
})
