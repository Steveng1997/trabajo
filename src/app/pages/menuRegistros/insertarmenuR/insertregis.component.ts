...
import { InsertregisService } from 'src/app/servicios/insertar/insertregis.service';

@Component({
  selector: 'app-insertregis',
  templateUrl: '../insertarmenuR/insertregis.component.html',
  styleUrls: ['../insertarmenuR/insertregis.component.css']
})
